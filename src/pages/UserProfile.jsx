        ...
        <>
            <div className="container">
                ...
                <div className="rightSidebar">
                    <h2>User Profile</h2>
                    <label for="name" class="form-label label">User Name</label>
                    ...
                    <input type="email" class="form-control input" id='email' placeholder='Type Email' />

                    <label for="number" class="form-label label">Mobile Number</label>
                    <input type="text" class="form-control input" id='number' placeholder='Mobile Number' />

                    <label for="address1" class="form-label label">Home Address1</label> <br />
                    <textarea name="address1" id="address1" cols="55" rows="3"></textarea> <br />

                    <label for="address2" class="form-label label">Home Address2</label> <br />
                    <textarea name="address2" id="address2" cols="55" rows="3"></textarea> <br />

                    <label for="city" class="form-label label">City</label>
                    <input type="text" class="form-control input" id='city' placeholder='City' />
                    <label for="postal" class="form-label label">Postal Code</label>
                    <input type="text" class="form-control input" id='postal' placeholder='Postal Code' />
                    <label for="country" class="form-label label">Country</label>
                    <input type="text" class="form-control input" id='country' placeholder='Country' />
